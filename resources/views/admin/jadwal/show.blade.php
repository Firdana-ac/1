              ...
              <tbody>
                  <tr>
                    <td>{{ $data->hari->nama_hari  ?? ' - '}}</td>
                      ...
                      <td>{{ $data->mhs->nis }}</td>
                      <td>{{ $data->penguji_item($data->promotor)->nama_dosen }}</td>
                      <td>{{ $data->penguji_item($data->kopromotor_1)->nama_dosen  }}</td>
                      <td>{{ $data->penguji_item($data->kopromotor_2)->nama_dosen }}</td>
                      <td>{{ $data->penguji_item($data->penguji_1)->nama_dosen }}</td>
                      <td>{{ $data->penguji_item($data->penguji_2)->nama_dosen }}</td>
                      <td>{{ $data->penguji_item($data->penguji_3)->nama_dosen }}</td>
                      <td>{{ $data->penguji_item($data->penguji_4)->nama_dosen }}</td>
                      <td>{{ $data->penguji_item($data->penguji_5)->nama_dosen }}</td>
